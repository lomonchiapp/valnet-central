...
export const newValnetUser = functions.https.onRequest(async (req, res) => {
    ...
    return corsHandler(req, res, async () => {
        ...
        try {
            const { nombres, apellidos, email, password, avatar = '', role, cedula, status, telefono, direccion, fechaNacimiento, brigadaId, nivelVendedor, contratosMes, bonoExtra } = req.body;
