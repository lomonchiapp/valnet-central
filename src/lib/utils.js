...
export function calculateNextPaymentDate(startDate, paymentDay) {
...
export function generateInvoiceNumber(paymentDay, paymentDate, citizenId) {
    const prefix = 'FC';
...
export function generatePaymentNumber(invoiceNumber) {
    const prefix = 'PAG';
...
export function generateCitizenCode(createdAt, id) {
    const prefix = 'CT';
