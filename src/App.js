...
export default function App() {
    return (_jsx(BrowserRouter, { children: _jsx(ThemeProvider, { defaultTheme: 'light', storageKey: 'vite-ui-theme', children: _jsxs(AuthProvider, { children: [_jsx(WallNetGlobalNotifier, {}), _jsx(AppRoutes, {}), _jsx(Toaster, {})] }) }) }));
}
