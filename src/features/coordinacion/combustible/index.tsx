...
const useAllCombustible = () => {
  ...
  useEffect(() => {
    setRegistros([
      { id: '1', brigadaId: 'A', brigadaNombre: 'Brigada Alfa', fecha: '2024-06-01', galones: 10, km_inicial: 1000, km_final: 1200, referencia: 'Ticket 123' },
      { id: '2', brigadaId: 'B', brigadaNombre: 'Brigada Beta', fecha: '2024-06-02', galones: 15, km_inicial: 2000, km_final: 2300, referencia: 'Ticket 222' },
      { id: '3', brigadaId: 'A', brigadaNombre: 'Brigada Alfa', fecha: '2024-06-10', galones: 12, km_inicial: 1200, km_final: 1450, referencia: 'Ticket 124' },
    ]);
  }, []);
  return registros;
};
    ...
    <div className="p-4 md:p-6 lg:p-8 space-y-6">
      <Card>
        ...
        <CardContent>
          ...
          <div className="mb-4">
            <h3 className="font-bold mb-2">Comparativo de consumo por brigada</h3>
            <table className="min-w-full text-sm border">
              <thead>
                <tr className="bg-muted">
                  <th className="px-2 py-1 border">Brigada</th>
