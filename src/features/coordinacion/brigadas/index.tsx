...
import {
  NuevaBrigadaForm,
  NuevaBrigadaFormValues,
} from './components/NuevaBrigadaForm'
    ...
    <div className='p-4 md:p-6 lg:p-8 space-y-6'>
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-muted-foreground'>
            Administra brigadas y control de combustible
          </p>
        </div>
        <Button onClick={handleOpenNuevaBrigada} className='gap-2'>
          <PlusCircle className='w-5 h-5' /> Nueva brigada
        </Button>
      </div>
        ...
        {brigadas.map((brigada) => (
          ...
          >
            ...
            <div className='text-xs text-muted-foreground'>
              Kilometraje actual: {brigada.kilometrajeActual ?? 0} km
            </div>
      ...
      <Dialog open={openBrigadaDialog} onOpenChange={setOpenBrigadaDialog}>
        <DialogContent className='sm:max-w-[500px]'>
          <DialogHeader>
            <DialogTitle>
              {editBrigada ? 'Editar brigada' : 'Nueva brigada'}
            </DialogTitle>
            <DialogDescription>
              {editBrigada
                ? 'Edita los datos de la brigada.'
                : 'Registra una nueva brigada.'}
            </DialogDescription>
          </DialogHeader>
          <NuevaBrigadaForm
          ...
          <DialogFooter>
            <Button
              variant='outline'
              onClick={() => setOpenBrigadaDialog(false)}
            >
              Cancelar
            </Button>
          </DialogFooter>
