...
export default function NuevoPagoRecurrenteForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (form.tipoMonto === TipoMonto.FIJO && !form.monto) {
      console.log('Monto validation failed', { tipoMonto: form.tipoMonto, monto: form.monto })
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className="space-y-8">
          <div className="bg-white p-8 rounded-lg border space-y-8">
            ...
            <div>
              <label className="block text-sm font-medium mb-2">Cuenta Contable *</label>
              <div className="flex gap-2">
                <Select
                  value={form.idcuenta}
                  onValueChange={(value) => setForm({ ...form, idcuenta: value })}
                >
                  <SelectTrigger>
                ...
                <Dialog open={showNuevaCuenta} onOpenChange={setShowNuevaCuenta}>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <Select
                  ...
                  onValueChange={(value) => setForm({ ...form, idproveedor: value })}
                >
                  <SelectTrigger>
        ...
        <div className="space-y-8">
          <div className="bg-white p-8 rounded-lg border space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium mb-2">Tipo de Monto *</label>
                <Select
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) => setForm({ ...form, metodoPago: value as MetodoPago })}
              >
                <SelectTrigger>
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) => setForm({ ...form, frecuencia: value as FrecuenciaPago })}
              >
                <SelectTrigger>
                ...
                <SelectContent>
                  ...
                  <SelectItem value={FrecuenciaPago.SEMANAL}>Semanal</SelectItem>
                  <SelectItem value={FrecuenciaPago.MENSUAL}>Mensual</SelectItem>
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    ...
                    >
                      ...
                      {form.fechaInicio ? format(form.fechaInicio, "PPP", { locale: es }) : "Selecciona fecha"}
                    </Button>
                  </PopoverTrigger>
                  <PopoverContent className="w-auto p-0">
                    <Calendar
                      ...
                      onSelect={(date) => date && setForm({ ...form, fechaInicio: date })}
                      initialFocus
                      locale={es}
                    />
                  </PopoverContent>
              ...
              <div>
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    ...
                    >
                      <CalendarIcon className="mr-2 h-4 w-4" />
                      {form.fechaFin ? format(form.fechaFin, "PPP", { locale: es }) : "Selecciona fecha"}
                    </Button>
                  </PopoverTrigger>
                  <PopoverContent className="w-auto p-0">
                    <Calendar
          ...
          <div className="bg-white p-8 rounded-lg border space-y-8">
            ...
            <div>
              ...
              <Select
                value={form.estado}
                onValueChange={(value) => setForm({ ...form, estado: value as EstadoPagoRecurrente })}
              >
                <SelectTrigger>
                  <SelectValue placeholder="Selecciona estado" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value={EstadoPagoRecurrente.ACTIVO}>Activo</SelectItem>
                  <SelectItem value={EstadoPagoRecurrente.INACTIVO}>Inactivo</SelectItem>
                </SelectContent>
              </Select>
            </div>
