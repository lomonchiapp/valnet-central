...
const metrics = [
  ...
  },
  {
    ...
    value: 34,
    icon: <HandshakeIcon className='h-4 w-4 text-muted-foreground' />,
  },
  {
        ...
        <div className='md:col-span-5 space-y-6'>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Últimos tickets atendidos o abiertos
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {recentTickets.map((ticket) => (
                  ...
                  >
                    ...
                    <div className='text-right'>
                      <span
                        className={`text-xs font-semibold ${ticket.status === 'Abierto' ? 'text-green-600' : 'text-gray-500'}`}
                      >
                        {ticket.status}
                      </span>
                      <p className='text-xs text-muted-foreground'>
