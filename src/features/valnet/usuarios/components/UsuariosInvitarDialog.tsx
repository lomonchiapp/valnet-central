  ...
  return (
    <form onSubmit={handleInvitar}>
      <DialogHeader>
        ...
        <DialogDescription>
          Envía invitaciones por correo electrónico para que nuevos usuarios se
          unan a la plataforma.
        </DialogDescription>
      </DialogHeader>
      ...
      <div className='space-y-4 py-4'>
        <div className='space-y-2'>
          <Label htmlFor='emails'>
            ...
            <span className='text-muted-foreground'>(separados por comas)</span>
          </Label>
          <Textarea
            id='emails'
            value={emails}
        ...
        <div className='bg-muted/50 p-3 rounded-md text-sm text-muted-foreground'>
          <p>
            Los usuarios invitados recibirán un correo electrónico con un enlace
            para registrarse. El enlace caducará después de 7 días.
          </p>
        </div>
      </div>
