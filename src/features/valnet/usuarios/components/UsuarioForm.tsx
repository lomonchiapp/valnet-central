...
import {
  ...
  StatusUsuario,
  Usuario,
} from '@/types/interfaces/valnet/usuario'
      ...
      <DialogHeader>
        ...
        <DialogDescription>
          {usuario
            ...
            : 'Agregar un nuevo usuario al sistema. Todos los campos marcados con * son obligatorios.'}
        </DialogDescription>
      </DialogHeader>
        ...
        <div className='space-y-4'>
          ...
          <div className='space-y-2'>
            ...
            <Select
              value={form.role}
              onValueChange={(value) =>
                handleChange('role', value as RoleUsuario)
              }
            >
              <SelectTrigger>
