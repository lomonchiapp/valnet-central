...
import { collection, query, orderBy, onSnapshot, addDoc, Timestamp, updateDoc, doc, arrayUnion, arrayRemove, deleteDoc, } from 'firebase/firestore';
...
export function useWallNetPosts() {
    ...
    const postMessage = async (newPost, user, category) => {
        setLoading(true);
    ...
    const listenComments = (postId, callback) => {
