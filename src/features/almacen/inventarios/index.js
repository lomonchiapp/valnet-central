...
export default function InventoriosLayout() {
    ...
    return (_jsxs("div", { className: 'p-4 md:p-6 lg:p-8 space-y-6', children: [_jsx(Tabs, { value: activeTab, defaultValue: activeTab, className: 'max-w-7xl mx-auto', onValueChange: (value) => {
                    switch (value) {
                        case 'inventarios':
                ...
                }, children: _jsxs(TabsList, { className: 'grid w-full bg-white grid-cols-4 border-b border-slate-200', children: [_jsxs(TabsTrigger, { value: 'inventarios', className: 'flex items-center data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm', children: [_jsx(Warehouse, { className: 'w-4 h-4 mr-2' }), " Inventarios"] }), _jsxs(TabsTrigger, { value: 'ubicaciones', className: 'flex items-center data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm', children: [_jsx(MapPin, { className: 'w-4 h-4 mr-2' }), " Ubicaciones"] }), _jsxs(TabsTrigger, { value: 'marcas', className: 'flex items-center data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm', children: [_jsx(Tag, { className: 'w-4 h-4 mr-2' }), " Marcas"] }), _jsxs(TabsTrigger, { value: 'proveedores', className: 'flex items-center data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm', children: [_jsx(Truck, { className: 'w-4 h-4 mr-2' }), " Proveedores"] })] }) }), getTitle() && (_jsxs("div", { className: 'flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4', children: [_jsx("div", { children: getTitle() }), isMainInventarioPage && inventariosParaMostrar.length > 0 && (_jsxs(Button, { onClick: () => setIsModalOpen(true), className: 'w-full sm:w-auto', children: [_jsx(PlusCircle, { className: 'mr-2 h-4 w-4' }), " Crear Nuevo Inventario"] }))] })), _jsx(Dialog, { open: isModalOpen, onOpenChange: setIsModalOpen, children: _jsx(DialogContent, { className: 'sm:max-w-[480px]', children: _jsx(NewInventoryForm, { onClose: () => setIsModalOpen(false), onSuccess: () => { } }) }) }), _jsx("div", { className: 'mt-6', children: renderContent() })] }));
}
