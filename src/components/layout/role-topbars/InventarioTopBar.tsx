...
export function InventarioTopBar() {
  ...
  useEffect(() => {
    ...
    if (inventarios.length > 0) {
      if (!currentInventario || !inventarios.find(inv => inv.id === currentInventario.id)) {
  ...
  return (
    <>
      <div className="flex-1">
        <h2 className="text-xl font-medium text-white">Gestión de Inventario</h2>
        <p className="text-sm text-muted-foreground text-gray-100">Visualiza y gestiona el stock de productos</p>
      </div>
                    ...
                    >
                      ...
                      <div>
                        ...
                        {inventario.descripcion && (
                          <div className="text-xs text-gray-500">{inventario.descripcion}</div>
                        )}
                      </div>
