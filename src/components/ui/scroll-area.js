...
const ScrollArea = React.forwardRef(({ className, children, orientation = 'vertical', ...props }, ref) => (_jsxs(ScrollAreaPrimitive.Root, { ref: ref, className: cn('relative overflow-hidden', className), ...props, children: [_jsx(ScrollAreaPrimitive.Viewport, { className: cn('h-full w-full rounded-[inherit]', orientation === 'horizontal' && '!overflow-x-auto'), children: children }), _jsx(ScrollBar, { orientation: orientation }), _jsx(ScrollAreaPrimitive.Corner, {})] })));
