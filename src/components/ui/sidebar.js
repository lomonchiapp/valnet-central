...
const Sidebar = React.forwardRef(({ side = 'left', variant = 'sidebar', collapsible = 'offcanvas', className, children, ...props }, ref) => {
    ...
    if (isMobile) {
        return (_jsxs(Sheet, { open: openMobile, onOpenChange: setOpenMobile, ...props, children: [_jsx(VisuallyHidden, { asChild: true, children: _jsx(SheetTitle, {}) }), _jsxs(SheetContent, { "data-sidebar": 'sidebar', "data-mobile": 'true', className: 'w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden', style: {
                        '--sidebar-width': SIDEBAR_WIDTH_MOBILE,
                    }, side: side, children: [_jsx(VisuallyHidden, { asChild: true, children: _jsx(SheetDescription, {}) }), _jsx("div", { className: 'flex h-full w-full flex-col', children: children })] })] }));
    }
