...
export function PaymentDatePicker({ selectedDay, onChange, className }: PaymentDatePickerProps) {
        ...
        {days.map((day) => (
          <Button
            ...
            className={cn(
              ...
              selectedDay === day && "bg-primary text-primary-foreground hover:bg-primary/90",
